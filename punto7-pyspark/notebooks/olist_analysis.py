"""
Olist PySpark Analysis — 5 Business Questions
Reads trusted parquet tables from S3 (or locally if S3_BUCKET not set).
"""
...
LOCAL_TRUSTED = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../../punto4-preparacion-glue/data/trusted")
)
...
if BUCKET:
    ...
    TRUSTED_BASE = LOCAL_TRUSTED
    REFINED_BASE = os.path.abspath(os.path.join(os.path.dirname(__file__), "../data/refined"))
...
q1_count = q1.count()
q1_path = f"{REFINED_BASE}/q1_ticket_por_estado"
...
q2_count = q2.count()
q2_path = f"{REFINED_BASE}/q2_reviews_negativas"
...
q3_count = q3.count()
q3_path = f"{REFINED_BASE}/q3_entrega_vs_score"
...
q4_count = q4.count()
q4_path = f"{REFINED_BASE}/q4_top_vendedores"
...
q5_count = q5.count()
q5_path = f"{REFINED_BASE}/q5_ordenes_mes_categoria"
...
print("\n" + "=" * 60)
print("SUMMARY — Olist Analysis Results")
print("=" * 60)
